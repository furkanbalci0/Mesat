...
public class ItemAdapter extends RecyclerView.Adapter<ItemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        holder.category.setText(auction.getDescription());
        holder.owner.setText(auction.getOwner_id() + "");
        DecimalFormat df = new DecimalFormat("###.#");
        holder.price.setText(df.format(auction.getStartingPrice()) + "₺");
        GlideUtil.downloadAndShow(this.context, auction.getShowcase_photo_id(), holder.imageView);
    }
